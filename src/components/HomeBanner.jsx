...
const HomeBanner = () => {
  ...
  return (
    // <div className='slider w-[100vw] lg:w-[850px] lg:h-[500px] rounded-lg relative'>
    // <div className='slider w-[100vw] lg:w-[850px] lg:h-[500px] overflow-hidden rounded-lg relative'>
    <div className='slider w-[100vw] overflow-hidden rounded-lg relative'>
      {/* <div className='slides w-[500%] lg:w-[500%] lg:h-full flex overflow-hidden relative'> */}
      <div className='slides w-[500%] flex overflow-hidden relative'>
        ...
        {/* <div className="navigation-auto absolute flex w-1/5 bottom-3 lg:w-[800px] justify-center lg:mt-[446px]"> */}
        ...
        {/* <div className="navigation-manual absolute w-1/5 bottom-3 lg:w-[800px] lg:bottom-[40px] flex justify-center"> */}
